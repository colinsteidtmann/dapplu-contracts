<br/>
<p align="center">
<a href="https://dapplu.com/" target="_blank">
<img src="./dappluLogo.png" width="225" alt="Dapplu logo">
</a>
</p>
<br/>

# Dapplu Contracts
 Implementation of the following dapplu-contracts using the [Hardhat](https://hardhat.org/) development environment:
...
```bash
git clone https://github.com/colinsteidtmann/dapplu-contracts
cd dapplu-contracts
```
then
...
To deploy to testnet (not set up at the moment though):
```bash
npx hardhat deploy --network kovan
```

## Test
Tests are located in the [test](https://github.com/colinsteidtmann/dapplu-contracts/tree/main/test) directory and can be modified as required. To run them:
