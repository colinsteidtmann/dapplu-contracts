...
contract BaseAgreement is ChainlinkClient {
        ...
        external
    {
        ...
        require(
            link.transferFrom(address(this), platformAddress, link.balanceOf(address(this))),
            "Unable to transfer"
        );
        ...
        internal
    {
        ...
        if (linkRemaining < _oracleFeeRequired) {
            require(link.transferFrom(platformAddress, address(this), _oracleFeeRequired), "Unable to transfer");
        }
    }
