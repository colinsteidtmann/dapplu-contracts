...
contract BaseAgreement is ChainlinkClient {
    bytes32 public apiResponse;
    address link= 0xa36085F69e2889c224210F603D836748e7dC0088; //Kovan link address
    address oracle = 0x2f90A6D021db21e1B2A077c5a37B3C7E75D15b7e; // kovan oracle address
        ...
        returns(bytes32 requestId)
    {
        ...
        req.add("get", "https://youtube.googleapis.com/youtube/v3/videos?part=statistics&id=6wgFliyJ4Bk&key=AIzaSyB8UEknqf0DmdJW5Ow6rGP8co7I_dZEhwo");
    ...
    function getApiResponse() public returns(bytes32) {
        return apiResponse;
    }
...
//         //   }
//         // }
//         console.log("chainlink", chainlinkOracleAddress());
//         req.add("path", "items.0.statistics.viewCount");
//         return sendChainlinkRequestTo(chainlinkOracleAddress(), req, _oracleFee);
//     }
