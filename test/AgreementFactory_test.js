...
//         agreementFactory = await AgreementFactory.connect(platform).deploy("0x06467Cf6AdE1B503908862918858d1045582C041", platform.address); // old base agreement address
...
//         // console.log("new addr = ", agreementAddr);
